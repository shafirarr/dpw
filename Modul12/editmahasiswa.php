<?php
  ...
  if (isset($_GET['npm'])) {
    ...
    // JANGAN tutup koneksi di sini agar variabel array $data bisa dibaca dengan aman oleh HTML di bawah
  } else {
    header("location:viewmahasiswa.php");
    exit;
  }
    ...
    <div class="card form-card fade-in">
        ...
        <form action="proses_editmahasiswa.php" method="post">
            <div class="form-group">
                ...
                <input type="number" name="npm" id="npm" value="<?php echo $data['npm']; ?>" readonly>
            </div>
            <div class="form-group">
